...
test("update_games", () => {
    ...
    const gamesRawExpected0 = fs.readFileSync("test/data/games-0-b.csv").toString();
    ...
    const gamesRawExpected1 = fs.readFileSync("test/data/games-1-b.csv").toString();
    ...
    const gamesRawExpected2 = fs.readFileSync("test/data/games-2-b.csv").toString();
